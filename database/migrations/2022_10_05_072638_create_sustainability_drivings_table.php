...
class CreateSustainabilityDrivingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sustainability_drivings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sustainability_drivings');
    }
}

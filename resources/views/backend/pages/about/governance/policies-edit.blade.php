                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('about.govermance.policies.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput4756">Show About Page</label>
                                    </div>
                                   <div class="n-chk">
                                        <label class="new-control new-radio radio-primary">
                                          <input type="radio" class="new-control-input" name="home"value="1" @if($data->about == 1) checked @endif ><span class="new-control-indicator pl-2"></span>Yes
                                        </label>
                                    </div>
                                    <div class="n-chk">
                                        <label class="new-control new-radio radio-primary">
                                          <input type="radio" class="new-control-input" name="home" value="0" @if($data->about == 0) checked @endif><span class="new-control-indicator pl-2"></span>No
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <a href="{{route('about.govermance.policies')}}" class="mt-4 btn btn-success">Back</a>
                                    </div>
                                </form>
                            </div>                                        
                        </div>

                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('about.policies.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input id="" type="hidden" name="about_governmance_policie_id" value="{{$p_id}}" class="form-control" value="">

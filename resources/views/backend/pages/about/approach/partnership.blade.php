...
active
@endsection
@section('about--approach-partner-active')
active
@endsection
@section("style")
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('about.approach.partnership.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="heading" type="text" name="heading" class="form-control" required value="{{$data->heading}}">
                                    </div>
                                    <!--<div class="form-group" >-->
                                    <!--    <label for="button_text">Button text</label>-->
                                    <!--    <input id="button_text" type="text" name="button_text" class="form-control" required value="{{$data->button_text}}">-->
                                    <!--</div>-->
                                    <!--<div class="form-group" >-->
                                    <!--    <label for="button_link">Button link</label>-->
                                    <!--    <input id="button_link" type="text" name="button_link" class="form-control" required value="{{$data->button_link}}">-->
                                    <!--</div>-->
                                    <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label for="exampleFormControlFile1" class="p-color">Required dimension (W:142 H:142)</label>
                                    </div>

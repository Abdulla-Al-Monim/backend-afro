...
active
@endsection
@section('about-banner-active')
active
@endsection

@section('about-overview-people-active')
active
@endsection
@section("style")
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('about.people.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput54">Footer</label>
                                        <input id="t-exampleFormControlInput54" type="text" name="footer" class="form-control" required value="{{$data->footer}}">
                                    </div>
                                    <div class="form-group" >

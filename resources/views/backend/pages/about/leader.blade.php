                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('about.leader.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input type="file" class="form-control-file" required accept=".png, .jpg, .jpeg, .webp" name="image" id="exampleFormControlFile1">
                                        <p class="p-color"> Required dimension (W:300 H:350)</p>
                                    </div>

                                    <div class="form-group" >
                                        <label for="exampleFormControlFile11">Qr code</label>
                                        <input type="file" class="form-control-file" accept=".png, .jpg, .jpeg, .webp"  required name="qr" id="exampleFormControlFile11">

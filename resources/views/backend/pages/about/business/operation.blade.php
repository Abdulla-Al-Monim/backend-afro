...
active
@endsection
@section('about--business-operation-active')
active
@endsection
@section("style")
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('about.business.operation.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label for="exampleFormControlFile1" class="p-color">Required dimension (W:781 H:333)</label>
                                    </div>
                                    <div class="form-group" >

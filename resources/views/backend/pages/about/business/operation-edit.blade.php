                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Our operation platform Update</h4>
                            </div>                 
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('about.business.operation.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label for="exampleFormControlFile1" class="p-color">Required dimension (W:140 H:151)</label>
                                        
                                    </div>
                                    <div class="form-group" >
                                        <input type="submit" name="txt" class="mt-4 btn btn-primary" value="Update">
                                        <a href="{{route('about.business.operation')}}" class="mt-4 btn btn-success">Back</a>

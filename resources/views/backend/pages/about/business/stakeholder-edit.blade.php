                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>To deliver value to our stakeholder update</h4>
                            </div>                 
                        </div>
                    </div>
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('about.stakeholder.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="t-exampleFormControlInput52" type="text" name="text" class="form-control" required value="{{$data->text}}">
                                    </div>
                                    <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <a href="{{route('about.business.stakeholder')}}" class="mt-4 btn btn-success">Back</a>

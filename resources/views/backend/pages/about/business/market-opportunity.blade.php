                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Strengths and market opportunities</h4>
                            </div>                 
                        </div>
                    </div>
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('about.business.market.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf

                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('contact.country.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="registation_name" type="text" name="registation_name" class="form-control" required value="{{$data->registation_name}}">
                                    </div>
                                    <div class="form-group" >
                                        <label for="address">Address</label>
                                        <input id="address" type="text" name="address" class="form-control" required value="{{$data->address}}">
                                    </div>
                                    <div class="form-group" >
                                        <label for="phone">Phone</label>
                                        <input id="phone" type="text" name="phone" class="form-control" required value="{{$data->phone}}">
                                    </div>
                                    <div class="form-group" >
                                        <label for="country_manager">Country manager</label>
                                        <input id="country_manager" type="text" name="country_manager" class="form-control" required value="{{$data->country_manager}}">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput33">Email</label>
                                        <input id="exampleFormControlInput33" type="email" name="email" class="form-control" required value="{{$data->email}}">
                                    </div>
                                    <h4>Location</h4>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput32">Longitude</label>
                                        <input id="exampleFormControlInput32" type="text" name="longitude" class="form-control" required value="{{$data->longitude}}">
                                    </div>
                                    <div class="form-group" >
                                        <label for="latitude">Latitude</label>
                                        <input id="latitude" type="text" name="latitude" class="form-control" required value="{{$data->latitude}}">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlFile1">Icon</label>
                                        <input type="file" class="form-control-file" accept=".png, .jpg, .jpeg, .webp" name="Country Icon" id="exampleFormControlFile1">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <a href="{{route('contact.country')}}" class="mt-4 btn btn-success">Back</a>

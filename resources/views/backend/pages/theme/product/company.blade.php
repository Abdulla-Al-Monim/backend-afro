                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('theme.project.community.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="exampleFormControlInput33" type="text" name="address" class="form-control" required value="">
                                    </div>
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <!-- <h4>Location</h4> -->
                                    </div> 

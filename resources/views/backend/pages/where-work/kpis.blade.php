                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('where.kpis.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput3">Country</label>
                                        <input id="exampleFormControlInput3" type="text" name="country" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput3">Tenancy ratio</label>
                                        <input id="exampleFormControlInput3" type="text" name="tenancy_ratio" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput3">Sites</label>
                                        <input id="exampleFormControlInput3" type="number" name="sites" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput34">Tenants</label>
                                        <input id="exampleFormControlInput34" type="number" name="tenants" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >

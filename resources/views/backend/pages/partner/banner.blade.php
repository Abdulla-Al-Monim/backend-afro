                                ...
                                <form action="{{route('partner.banner.update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="n-chk">
                                        <label class="new-control new-radio radio-primary">
                                          <input type="radio" class="new-control-input" name="default" value="0" @if($data->default == 0) checked @endif><span class="new-control-indicator pl-2"></span>Image
                                        </label>
                                    </div>
                                    
                                    <div class="n-chk">
                                        <label class="new-control new-radio radio-primary">
                                          <input type="radio" class="new-control-input" name="default" value="1" @if($data->default == 1) checked @endif><span class="new-control-indicator pl-2"></span>Video
                            
                                        </label>
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput5">Youtube link </label>
                                        <input id="t-exampleFormControlInput5" type="text" name="link" class="form-control" required value="{{$data->link}}">
                                    </div>
                                    <div class="form-group" >

...
active
@endsection
@section('partner-active-environment')
active
@endsection
@section("style")
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('partner.environment.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label for="exampleFormControlFile1" class="p-color">Required dimension (W:320 H:500)</label>
                                    </div>

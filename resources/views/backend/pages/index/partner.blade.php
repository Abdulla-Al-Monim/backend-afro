                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('index.partner.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput5">Heading</label>
                                        <input id="t-exampleFormControlInput5" type="text" name="heading" class="form-control" required value="{{$data->heading}}">
                                    </div>

                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('index.award.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                   <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput4756">Show Hone Page</label>
                                    </div>
                                    <div class="n-chk">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <a href="{{route('index.award')}}" class="mt-4 btn btn-success">Back</a>
                                    </div>
                                </form>
                            </div>                                        
                        </div>

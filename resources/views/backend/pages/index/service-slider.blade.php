...
active
@endsection
@section('index-active-service-slider')
active
@endsection
@section("style")
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('index.service.slider.add')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="exampleFormControlInput3" type="number" name="site" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="short_description" type="text" name="short_description" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >

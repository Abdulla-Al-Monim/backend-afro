                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('index.magazine.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput3">Heading</label>
                                        <input id="exampleFormControlInput3" type="text" name="heading" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput33">Title</label>
                                        <input id="exampleFormControlInput33" type="text" name="title" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput332">Short Description</label>
                                        <input id="exampleFormControlInput332"  type="text" name="sort_description" class="form-control" required value="">
                                    </div>
                                    <!-- <div class="form-group" >
                                        <label for="exampleFormControlInput333">Button link</label>
                                        <input id="exampleFormControlInput333" type="text" name="button_link" class="form-control" required value="">
                                    </div> -->
                                    <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label for="exampleFormControlFile12" class="p-color">Required dimension (W:535 H:350)</label>
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlFile1">Description Image</label>
                                        <input type="file" class="form-control-file" accept=".png, .jpg, .jpeg, .webp" name="image_banner" id="exampleFormControlFile1" required>

...
active
@endsection
@section('solution-active-banner')
active
@endsection
@section("style")
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('solution.banner.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="t-exampleFormControlInput5" type="text" name="link" class="form-control" required value="{{$banner->link}}">
                                    </div>
                                    <div class="form-group" >

                            ...
                            <div class=" col-12">
                                <form action="{{route('media.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input id="t-exampleFormControlInput2e" type="date" name="date" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput2ee">Button text</label>
                                        <input id="t-exampleFormControlInput2ee" type="text" name="button_text" class="form-control" required value="">
                                    </div>
                                    <div class="form-group" >
                                        <label for="exampleFormControlInput2ee">Button Link</label>
                                        <input id="t-exampleFormControlInput2ee" type="text" name="button_link" class="form-control" required value="">
                                    </div>

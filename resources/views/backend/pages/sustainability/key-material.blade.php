                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('sustainability.key.material.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input id="" type="hidden" name="sustainability_material_id" value="{{$p_id}}" class="form-control" value="">

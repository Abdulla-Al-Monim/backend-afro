...
active
@endsection
@section('sustainability-proposition-active')
active
@endsection
@section("style")
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('sustainability.proposition.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <label for="exampleFormControlFile1" class="p-color">Required dimension (W:420 H:344)</label>
                                    </div>

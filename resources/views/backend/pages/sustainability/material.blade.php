                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <form action="{{route('sustainability.material.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                   ...
                                   <div class="n-chk">
                                        <label class="new-control new-radio radio-primary">
                                          <input type="radio" class="new-control-input" name="home" value="1" checked><span class="new-control-indicator pl-2"></span>Yes
                                        </label>
                                    </div>
                                    <div class="n-chk">
                                        <label class="new-control new-radio radio-primary">

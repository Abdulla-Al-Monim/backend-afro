                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-lg-6 col-12 mx-auto">
                                <form action="{{route('sustainability.key.material.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <a href="{{route('sustainability.material',$data->about_report_id)}}" class="mt-4 btn btn-success">Back</a>
                                    </div>
                                </form>
                            </div>                                        
                        </div>

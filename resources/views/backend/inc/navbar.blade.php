    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="https://afro-group.net/"><img alt="logo" src="{{ asset('backend') }}/assets/img/logo.png"> <span class="navbar-brand-name">Afro</span></a>
            </div>
